...
class jugador extends Controller
{
    ...
    {
        $Jugadores = User::select('users.id' ,'users.id_Equipo','Equipos.Nombre','users.FechaNacimiento','users.id_Equipo','users.name','users.ApellidoP','users.ApellidoM','Liga.Nombre as LigaNombre' )
